    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? page, bool resetFilter = false)
        {
            ...
            HomePostVM homePostVM = new HomePostVM()
            {
                ...
                BrandList = brandList,
                VehicleTypeList = vehicleTypeList,
                BrandId = TempData["SelectedBrandId"] != null ? (Guid?)TempData["SelectedBrandId"] : null,
                VehicleTypeId = TempData["SelectedVehicleTypeId"] != null ? (Guid?)TempData["SelectedVehicleTypeId"] : null,
            };
